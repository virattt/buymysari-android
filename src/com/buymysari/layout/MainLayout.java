...
public class MainLayout extends FrameLayout {
    ...
    */
    ...
    protected void onAttachedToWindow() {
        ...
        content = (FrameLayout) this.getChildAt(0);  
        shadow = ((FrameLayout)content.getChildAt(0)).getChildAt(1);
    ...
    public void toggleMenu() {
        ...
        case SHOWN:
        	...
        	moveRightoLeft.setFillAfter(false);
